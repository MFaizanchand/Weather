...
import PrevForecast from './components/PrevForecast';
...
const App = () => {
  ...
  return (
    <NavigationContainer>
    <Stack.Navigator
    screenOptions={{headerShown:false}} initialRouteName='HomeScreen'>
      <Stack.Screen name="HomeScreen" component={HomeScreen} />
      <Stack.Screen name="PrevForecast" component={PrevForecast} />
    </Stack.Navigator>
  </NavigationContainer>
  )
}
...
//     const newloc =   firestore().collection("forecast").add({
//       recentloc: loc.name,                       // location.name 
//       estimatedtemp : current?.temp_c,
//     })
