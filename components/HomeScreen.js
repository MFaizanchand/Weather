...
const HomeScreen = ({ navigation }) => {
    ...
    const addPrevLoc = (loc)=>{
      const newloc =   firestore().collection("forecast").doc('faizan1').set({
          ...
          <View style={{ height: '7' }} className='mx-4 relative z-50' >
            ...
            <View className='flex-row justify-end items-center rounded-full mt-3'
              ...
              {showSearch ?
                ...
                : null}
                <TouchableOpacity style={{ marginRight:2, backgroundColor: '#221910' }}
                className='rounded-full p-3 m-1  '
                onPress={() => navigation.navigate('PrevForecast')} >
                <Image source={require('../assets/placeholder.png')} /></TouchableOpacity>
